...
static void SwapPtPt(volatile float32_t **a, volatile float32_t **b);
...
extern float MedianFilter(median* this, volatile float32_t input)
{
...
static void MedianBufferShellSort(median* this)
{
    ...
    while (gap > 0)
    {
        ...
        {   
            volatile float32_t* currentElement = this->ptBufferSorted[index];
